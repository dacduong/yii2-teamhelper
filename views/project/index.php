        ...
        'controlOptions' => [
            ...
            'pluginOptions' => [
                'ajax' => [
                    ...
                    'data' => new JsExpression('function(params) { return {q:params.term, type:"customer"}; }'),
                ],
...
echo GridView::widget([
    ...
    'panel' => [
        ...
        'heading' => '<i class="glyphicon glyphicon-book"></i>  Project',
    ],
    'persistResize' => false,
]);
Pjax::end();
